...
namespace ClaseNet
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (frase != 0)
            {
                Console.WriteLine("Seleccione el numero del ejercicio:\n 1-mostrar los numero impar entre el 0 al 100 \n" +
                "2-Ingresar 2 numeros, imprima los numeros naturales \n 3-Ingresar una frase no mas de 20 caracteres y mostrar cuantas vocales tiene\n" +
                " 4-Ingresar 3 datos y decir que clase de triangulo es\n 5-mostrar los multiplos de 3 y de 2 entre el 0 y el 100\n PARA SALIR PRESIONE 0");
                frase = Convert.ToInt16(Console.ReadLine());
                switch (frase)
                {
                    case 1:
                    ...
                    case 5:
                        ...
                        int mul3 = 0;
                        int mul2 = 0;
                        Console.WriteLine("numero multiplo de 3 es ");
                        for (int i = 0; i <= 100; i++)
                        {
                            if (i % 3 == 0)
                            {
